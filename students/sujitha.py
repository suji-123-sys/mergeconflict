...
class Student:
    def __init__(self,main):
        ...
        self.T_Frame.pack()
        self.Title = Label(self.T_Frame, text="Student Management System", font="arial 20 bold",width=1200, bg="yellow", bd=2)
        self.Title.pack()
      ...
      # ######################BUTTONS#########################
        ...
        self.tree.insert("", index=0, values=(1, "sujitha", 22, "09-04-2002", "female", "mettupalayam"))
        self.tree.pack()
    def Add(self):
